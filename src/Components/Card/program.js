...
export default function Card2() {
    ...
    async function BuscaSP(){
        const resposta = await api.get(
            "https://api.weatherapi.com/v1/forecast.json?key=2e82310f836647b0860190506222309&q=sao%20paulo&days=1&aqi=no&alerts=no"
        );
    ...
    async function BuscaCWB(){
        const resposta = await api.get(
            "https://api.weatherapi.com/v1/forecast.json?key=2e82310f836647b0860190506222309&q=curitiba&days=1&aqi=no&alerts=no"
        );
    ...
    async function BuscaNATAL(){
        const resposta = await api.get(
            "https://api.weatherapi.com/v1/forecast.json?key=2e82310f836647b0860190506222309&q=natal&days=1&aqi=no&alerts=no"
        );
